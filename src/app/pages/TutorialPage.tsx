...
export function TutorialPage({ tutorialId, returnTo, onNavigate }: TutorialPageProps) {
    ...
    <div className="p-6 pt-24 pb-36 max-w-[600px] mx-auto">
      ...
      <div className="space-y-4">
        <Button
          variant="primary"
          fullWidth
          onClick={() => onNavigate('daily-task', returnTo, tutorialId)}
        >
          Começar missão
        </Button>

        <Button variant="secondary" fullWidth onClick={() => onNavigate(returnTo)}>
          Voltar
        </Button>
